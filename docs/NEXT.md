...
| S8 | **U3b → U3a → U3c** | U3a ✔ merged 2026-09-20; U3c (desktop app shell) launched 2026-09-22 | Desktop app (PySide6, native widgets): **U3b** strip view + side-by-side viewer ✔ merged; **U3a** models view (card written); **U3c** main window, library, reader integration, `omniscan gui`, settings (needs a user-config writer, director) | in progress |
