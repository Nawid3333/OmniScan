...
| OCR: PP-OCRv5 Korean / PP-OCRv6 zh+ja recognition via `transformers`; PaddleOCR-VL as second opinion | Recognition verified; detection/line grouping not yet | planned |
