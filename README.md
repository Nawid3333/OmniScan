...
| web viewer | working — `omniscan serve` + `npm run dev` (read-only Slicer, OCR, Translation and Reader views; the OCR/Translation views need an `ocr.json`, which no stage produces yet) |
