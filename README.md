...
| studio (manual editing) | working — the web UI's Studio view: draw/move/resize/delete text boxes, fix OCR text, write English lines; edits survive every re-run (`edits.json`) |
